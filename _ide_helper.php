...
namespace LukePOLO\LaraCart\Facades {
    ...
    class LaraCart {
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
         ...
         *
         * @param string $instance
         * @return \LukePOLO\LaraCart\LaraCart cart instance
         * @static
         */
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->getAttribute($attribute, $defaultValue);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->removeAttribute($attribute);
        }
         ...
         * @static
         */
        public static function addLine($itemID, $name = null, $qty = 1, $price = '0.00', $options = [], $taxable = true)
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->addLine($itemID, $name, $qty, $price, $options, $taxable);
        }
         ...
         * @static
         */
        public static function add($itemID, $name = null, $qty = 1, $price = '0.00', $options = [], $taxable = true, $lineItem = false)
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->add($itemID, $name, $qty, $price, $options, $taxable, $lineItem);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->addItem($cartItem);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->increment($itemHash);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->decrement($itemHash);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->updateItem($itemHash, $key, $value);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->removeItem($itemHash);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->findCoupon($code);
        }

        /**
         * Applies a coupon to the cart.
         *
         * @param \LukePOLO\LaraCart\Contracts\CouponContract $coupon
         * @static
         */
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->removeCoupon($code);
        }
         ...
         * @static
         */
        public static function addFee($name, $amount, $taxable = false, $options = [])
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->addFee($name, $amount, $taxable, $options);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->taxTotal($format);
        }

        /**
         * @static
         */
        public static function feeTaxTotal($format = true)
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->feeTaxTotal($format);
        }

        /**
         * @static
         */
        public static function feeTaxSummary()
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->feeTaxSummary();
        }

        /**
         * @static
         */
        public static function taxSummary()
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->taxSummary();
        }
         ...
         * @static
         */
        public static function total($format = true)
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->total($format);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->netTotal($format);
        }

        /**
         * @static
         */
        public static function itemTotals($format = true)
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->itemTotals($format);
        }
         ...
         * @static
         */
        public static function subTotal($format = true)
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->subTotal($format);
        }
        ...
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->count($withItemQty);
        }
        ...
        {
            return \LukePOLO\LaraCart\LaraCart::formatMoney($number, $locale, $currencyCode, $format);
        }

        /**
         * @static
         */
        public static function feeSubTotal($format = true)
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->feeSubTotal($format);
        }
         ...
         * @static
         */
        public static function discountTotal($format = true)
        {
            /** @var \LukePOLO\LaraCart\LaraCart $instance */
            return $instance->discountTotal($format);
        }
