    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h3 class="text-sm font-medium text-gray-500 truncate">{{ __('transactions_current_balance') }}</h3>
                <p class="mt-1 text-3xl font-semibold text-gray-900">{{ number_format($stats['current_balance'], 2) }} €</p>
            </div>

            <!-- total deductions -->
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h3 class="text-sm font-medium text-gray-500 truncate">{{ __('transactions_total_deductions') }}</h3>
                <p class="mt-1 text-3xl font-semibold text-red-600">{{ number_format($stats['total_deductions'], 2) }} €</p>
            </div>

            <!-- total refunds -->
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h3 class="text-sm font-medium text-gray-500 truncate">{{ __('transactions_total_refunds') }}</h3>
                            ...
                            @forelse ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        ...
                                        >
                                            {{ __('transactions_type_2_' . $transaction->type) }}
                                        </span>
                                    </td>
