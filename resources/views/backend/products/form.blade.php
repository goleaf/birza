    ...
    <div class="rounded-lg bg-white shadow-sm">
        ...
        <form wire:submit.prevent="save" enctype="multipart/form-data" class="space-y-6 p-6">
            <div class="rounded-lg bg-gray-50 p-6 shadow-sm">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="price" wire:model.defer="price" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="pack_type" wire:model.defer="pack_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <select id="unit" wire:model.defer="unit" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <select id="country_of_origin" wire:model.defer="country_of_origin" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <select id="is_organic" wire:model.defer="is_organic" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <select id="is_active" wire:model.defer="is_active" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" id="stock" wire:model.defer="stock" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-gray-50 p-6 shadow-sm">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="number" step="0.01" id="min_order_price" wire:model.defer="min_order_price" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="min_order_count" wire:model.defer="min_order_count" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.001" id="package_weight" wire:model.defer="package_weight" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="price_per_liter" wire:model.defer="price_per_liter" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-gray-50 p-6 shadow-sm">
                ...
                <textarea id="description" wire:model.defer="description" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
            </div>
                    ...
                    <div class="space-y-6">
                        @foreach ($attributes as $attribute)
                            <div>
                                ...
                                <select wire:model.defer="attributeSelections.{{ $attribute->id }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="">{{ __('common_select_option') }}</option>
